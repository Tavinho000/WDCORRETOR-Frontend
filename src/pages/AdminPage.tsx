...
const AdminPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        const response = await axios.get('https://wdcorretor-backend.onrender.com/propriedades');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const response = await axios.post('https://wdcorretor-backend.onrender.com/propriedades', farmData);
  ...
  const handleDelete = async (idToDelete: string) => {
    try {
      await axios.delete(`https://wdcorretor-backend.onrender.com/propriedades/${idToDelete}`);
